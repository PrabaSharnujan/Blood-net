	...
	<div class="agileits-contact py-5">
		<div class="py-xl-5 py-lg-3">
			...
			<div class="w3ls-titles text-center mb-5">
				...
				<p class="mt-2">Our blood donor list features dedicated individuals who have generously donated blood to save lives. Each donor's name, blood type, and donation history are included, showcasing their invaluable contributions. Join our community of heroes and help us ensure a steady supply for those in need. Your donation makes a difference!</p>
			</div>
			<div class="d-flex">
